...
from lumi.ui.player.overlay.state import CROSS_ORDER, FocusZone, OverlayState, TrackKind, View
...
class InputRouter:
    ...
    def route_mouse_press(
        ...
        *,
        ...
        for key in ("m1", "m10", "center", "p10", "p1", "subs", "audio"):
            rect = hit_regions.get(key)
