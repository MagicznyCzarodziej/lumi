"""Media grouping episodes screen."""
...
from lumi.ui.navigation.destinations import Destination, MediaGroupingEpisodesGroupDestination
from lumi.ui.poster_loader import PosterLoader
from lumi.ui.screens.list_with_poster_screen import ListWithPosterScreen
from lumi.ui.screens.media_grouping_episodes.controller import build_media_grouping_episodes_state
from lumi.ui.strings import LIBRARY_LABEL


class MediaGroupingEpisodesGroupScreen(ListWithPosterScreen):
    ...
    def bind(self, destination: Destination, context: ScreenContext) -> None:
        if not isinstance(destination, MediaGroupingEpisodesGroupDestination):
            return
        state = build_media_grouping_episodes_state(
            destination,
