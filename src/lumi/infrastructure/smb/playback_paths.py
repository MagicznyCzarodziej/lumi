...
from lumi.domain.filesystem.path_candidates import directory_path_candidates, library_path_candidates
...
playback_path_candidates = library_path_candidates
